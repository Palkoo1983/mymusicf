# EnZenem 2.0.2 – biztonsági javítás és élő ellenőrzés

## Mit javít ez a verzió?

- A sikeres visszairányítás után a szerver a Viva `Retrieve Transaction` API-ján
  külön ellenőrzi a tranzakcióazonosítót, a 16 számjegyű rendeléskódot, a
  `statusId = F` sikeres állapotot, a pontos összeget és a HUF pénznemet.
